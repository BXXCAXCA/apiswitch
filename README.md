...
- 当前发布版本为 [`v0.1.11`](https://github.com/BXXCAXCA/apiswitch/releases/tag/v0.1.11)：统一声明候选与辅助工作流共同提供的有效能力；OpenAI、Gemini、OpenCode、OpenClaw 与 Cherry Studio 可识别由辅助模型提供的图像输入能力，避免客户端在请求发出前丢弃图片。
